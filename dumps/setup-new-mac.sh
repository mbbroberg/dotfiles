...
git config --global user.email 1744971+mbbroberg@users.noreply.github.com
...
# https://github.com/paulmillr/dotfiles/blob/master/etc/osx.sh
# and
# https://github.com/mbbroberg/osx-bootstrap/blob/master/settings.sh
